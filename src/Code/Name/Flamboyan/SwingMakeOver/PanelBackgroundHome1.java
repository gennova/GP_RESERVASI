 ...
 * @author PresdirTendy
 */
public class PanelBackgroundHome1 extends JPanel{

    private Image image;

    public PanelBackgroundHome1() {
        setOpaque(false);
        image = new ImageIcon(getClass().getResource("/Code/Name/Flamboyan/Files/hotel.jpg")).getImage();
    }
