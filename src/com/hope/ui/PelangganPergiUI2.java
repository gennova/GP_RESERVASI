 ...
 * @author laravel
 */
public class PelangganPergiUI2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA PELANGGAN PERGI BERDASARKAN KANTOR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (checkBaru.isSelected()) {
            PelangganTableModel ptm = new PelangganTableModel(DaoFactory.getPelangganDao().GetAllPelangganTahunUnikKantorPergi(combotahun.getSelectedItem().toString()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PelangganPergiUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PelangganPergiUI2().setVisible(true);
            }
        });
    }
